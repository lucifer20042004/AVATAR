...
keyboard = {
{'مطــ ــور الســورس',' اسعار افتار','مـــ ـالـ ـك الــسـ ــورس','𝙳𝙴𝚅𝙴𝙻𝙾𝙿𝚁'},
{'╭──── ● «𝔸𝕍𝔸𝕋𝔸ℝ » ● ────╮'},
...
send(msg.chat_id_, msg.id_,'  🕸  اصدار سورس افتار { s: 6.7}')
end
...
{{text = 'قناه السورس️️', url="t.me/avtt_sorce"}}, 
} 
...
{{text = '((𝔸𝕍𝔸𝕋𝔸ℝ ))', url="t.me/avtt_sorce"}}, 
}
...
send(msg.chat_id_,0,"  🕸  العضو : {["..data.first_name_.."](T.ME/avtt_sorce)}\n  🕸  ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, "  🕸  عذرا ⇎ {["..data.first_name_.."](T.ME/avtt_sorce)}\n  🕸  عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
local Text = [[
╭──── ● «𝔸𝕍𝔸𝕋𝔸ℝ » ● ────╮
[W𝔼𝕃ℂ𝕆𝕄 𝕀ℕ 𝕊𝕆𝕌ℝℂ𝔼 𝔸𝕍𝔸𝕋𝔸ℝ ](t.me/avtt_sorce) 
[THE BEST SOURCE ON TETLEGRAM](t.me/avtt_sorce) 
[FOLLOW STAR IN BOUTTONS BELOE](t.me/avtt_sorce) 
╰──── ● «𝔸𝕍𝔸𝕋𝔸ℝ » ● ────╯
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
local Text = [[
✭اهلا بيك في سورس افتار لو عايز بوت بكل حقوقك ع السورس تواصل معي✭
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '⌯｟ᴅᴇᴠ 𝚕𝚞𝚌𝚒𝚏𝚎𝚛｠⌯',url="t.me/LLucifeerr"}},
{{text = '⌯｟ᴅᴇᴠ ᴠᴏᴅᴋᴀ｠⌯',url="t.me/DV_Vo_Dk_A1"}},
{{text = '⌯｟TWASEL✰｠⌯',url="t.me/TWASOL7_bot"}},
{{text = '⌯｟CHANNEL✰｠⌯',url="t.me/avtt_sorce"}}, 
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/sorce_wWolf/21&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'مبرمج السورس' or text == 'كساحه' or text == 'لوسيفر' then
local Text = [[
...
if text == 'فودكا' or text == 'فوديكا' or text == 'مبرمج السورس' then
local Text = [[
ٲٲلبشمبرمج فؤدكٲٲٲ لو حابب تتواصل معاه❤
لو حاببتتواصلمعاه اتبع الزرالي تحت 🔽
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '⌯｟ᴅᴇᴠ ᴠᴏᴅᴋᴀ ｠⌯',url="t.me/DV_Vo_Dk_A1"}},
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/sorce_wWolf/20&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == 'يوتيوب'  then
local Text = [[
بوت اليوتيوب الخاص بسورس افتار
اتبع الزر إلى تحت ↓
...
local TWEET_Msg = { 
"((✭╭──── ● «𝔸𝕍𝔸𝕋𝔸ℝ » ● ────╮✭))",
"اهلا بك عزيزي في اسعار سورس افتار",
"لو عايز بوت بكل حقوقك علي سورس افتار بكل المميزات⇐10جنيه",
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس ', url="t.me/avtt_sorce"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == '╭──── ● «𝔸𝕍𝔸𝕋𝔸ℝ » ● ────╮' or text == '╰──── ● «𝔸𝕍𝔸𝕋𝔸ℝ » ● ────╯' then
local Text = [[ 
╭──── ● «𝔸𝕍𝔸𝕋𝔸ℝ » ● ────╮
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𝐒𝐎𝐔𝐑𝐂𝐄 𝐑𝐀𝐁𝐄𝐑𝐙 ', url="t.me/avtt_sorce"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
if text == 'العاب افتار' or text == 'العاب متطوره' then  
local Text = [[  
 🕸 اهلا في قائمه الالعاب المتطوره سورس افتار  🕸 
...
{{text = 'SOURCE CHANNEL ', url="t.me/avtt_sorce"}},
}  
local msg_id = msg.id_/2097152/0.5  
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token.. /sendVideo?chat_id=  .. msg.chat_id_ ..  &video=https://t.me/story_AV/ ..ght.. &caption=  .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == "رمزيه" or text == "رمزيه" or text == "رمزيات" and not  database:get(bot_id.."sing:for:me"..msg.chat_id_) then 
ght = math.random(3,200); 
local Text = "تم اختيار الرمزيه الخاصه بك🤤♥"  
keyboard = {}  
keyboard.inline_keyboard = { 
{{text =  ᴅᴇᴠ 𝚕𝚞𝚌𝚒𝚏𝚎𝚛  ,url="t.me/LLucifeerr"}}, 
{{text =  ᴅᴇᴠ ᴠᴏᴅᴋᴀ ,url="t.me/DV_Vo_Dk_A1"}}, 
...
elseif text == 'قفل افتاررسيه' and msg.reply_to_message_id_ == 0 and Manager(msg) then 
...
elseif text == 'فتح افتاررسيه' and msg.reply_to_message_id_ == 0 and Manager(msg) then 
...
if result.id_ == tonumber(1804978483) then
send(msg.chat_id_, msg.id_, "  🕸  لا يمكنك حظر مبرمج السورس \n")
return false 
end
...
if tonumber(userid) == tonumber(1804978483) then  
send(msg.chat_id_, msg.id_, "  🕸  لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
if Get_info then
local TextS = "\n  🕸  اهلا بك في متجر ملفات افتار\n  🕸  ملفات السورس ↓\n•═════•| ☩𝔸𝕍𝔸𝕋𝔸ℝ ☩ |•═════•\n\n"
local TextE = "\n•═════•| ☩𝔸𝕍𝔸𝕋𝔸ℝ ☩ |•═════•\n  🕸  علامة تعني { ✔️ } ملف مفعل\n  🕸  علامة تعني { ✖ } ملف معطل\n  🕸  قناة سورس افتار ↓\n".."  🕸  [اضغط هنا لدخول](t.me/avtt_sorce) \n"
local NumFile = 0
...
send(msg.chat_id_, msg.id_,"  🕸  عذرا الملف لايدعم سورس افتار \n") 
end
return false
end
...
if text == ("مسح قائمه افتار") and Sudo(msg) then
database:del(bot_id..'CoSu'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n  🕸  تم مسح قائمه افتار')
return false
end

if text == 'قائمه افتار' and Sudo(msg) then
...
if text == ("رفع افتار") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع افتار @(.*)$") and Sudo(msg) then
local username = text:match("^رفع افتار @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع افتار (%d+)$") and Sudo(msg) then
local userid = text:match("^رفع افتار (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == ("تنزيل افتار") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل افتار @(.*)$") and Sudo(msg) then
local username = text:match("^تنزيل افتار @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل افتار (%d+)$") and Sudo(msg) then
local userid = text:match("^تنزيل افتار (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
send(msg.chat_id_,msg.id_, '[انت مطوري نور عنيا🥺🤍](t.me/avtt_sorce)') 
return false
end

if text == 'انا مين' and DevSoFi(msg) then 
send(msg.chat_id_,msg.id_, '[انت مطوري الثاني حته مني 😍💚](t.me/avtt_sorce)') 
return false
end

if text == 'انا مين' and Sudo(msg) then 
send(msg.chat_id_,msg.id_, '[انت المطور بس الصغنن 🌝💘](t.me/avtt_sorce)') 
return false
end

if text == 'انا مين' and CoSu(msg) then 
send(msg.chat_id_,msg.id_, '[نت المالك هن يعني حاجه فوق فوف راسي 😂♥](t.me/avtt_sorce)') 
return false
end

if text == 'انا مين' and Constructor(msg) then 
send(msg.chat_id_,msg.id_, '[انت منشئ يسطا عتلاء منشئ عاوز حاجه تانيه😹🤦‍♂️](t.me/avtt_sorce)') 
return false
end

if text == 'انا مين' and BasicConstructor(msg) then 
send(msg.chat_id_,msg.id_, '[ انت هنا منشئ اساسي يعني اعلى رتبه عاوزك تفتخر😂🎯](t.me/avtt_sorce)') 
return false
end

if text == 'انا مين' and Manager(msg) then 
send(msg.chat_id_,msg.id_, '[ انت المدير يعني الروم تحت سيطرتك😹](t.me/avtt_sorce)') 
return false
end

if text == 'انا مين' and Mod(msg) then 
send(msg.chat_id_,msg.id_, '[انت مجرد ادمن اجتهد عشان ياخد رتبه😹 ](t.me/avtt_sorce)') 
return false
end

if text == 'انا مين' and Special(msg) then 
send(msg.chat_id_,msg.id_, '[ انت مميز ابن ناس 😊 ](t.me/avtt_sorce)') 
return false
end

if text == 'انا مين' then
send(msg.chat_id_,msg.id_, '[انت مجرد عضو زليل حقير ملوش لزمه 😂](t.me/avtt_sorce)') 
return false
end
...
if text == 'سلام' then 
send(msg.chat_id_,msg.id_, '[ابق تعاله كليوم..😹💔🎶](t.me/avtt_sorce)') 
return false
end

if text == 'هاي' or text == 'هيي' then
send(msg.chat_id_,msg.id_, '[العب.....تراي😺💜](t.me/avtt_sorce)') 
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم برايفت والنبي..🥺💜](t.me/avtt_sorce)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[عليه الصلاه والسلام..💛🙂](t.me/avtt_sorce)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[نزل عينك عيب كده..🌚♥️](t.me/avtt_sorce)') 
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[يحلات عيونك..♥️🦋](t.me/avtt_sorce)')
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[عايز من ده..💋🥀](t.me/avtt_sorce)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم بف..🙄💔](t.me/avtt_sorce)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[متزعلش بحبك..😥♥️](t.me/avtt_sorce)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[وانا كمان بحبك .🥺❤️](t.me/avtt_sorce)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم بيف ..🙄💔](t.me/avtt_sorce)')
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[وعليكم السلام ..🖤🌚](t.me/avtt_sorce)') 
return false
end
end
end
...
{
{text = 'SOURCE STAR', url="t.me/avtt_sorce"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
local Teext =[[
•═════•| ☩𝔸𝕍𝔸𝕋𝔸ℝ ☩ |•═════•
🕸 بك في مميزات سورس افتار🕸
•═════•| ☩𝔸𝕍𝔸𝕋𝔸ℝ ☩ |•═════•
🕸 مميزات الخاصه بسورس افتار🕸
•═════•| ☩𝔸𝕍𝔸𝕋𝔸ℝ ☩ |•═════•
كت تويت ⇜ تويت 
انصحني ⇜ انصحنى⇜انصح 
الصراحه ⇜ صراحه 
